...
# like here, so that these options transfer accross multiple diagrams. Or you can
...
# not a fixed term. Which means, that design_graphics() can be extended with custom
# diagram types.
my_data |>
...
# For manual breaks in your texts, use vectors or the escape sequence /n.
my_data |>
    design_graphic(axes_variables = age,
                   segments       = sex,
                   values         = weight,
...
# In the titles and footnotes you can use the special key word [by_var] to display
